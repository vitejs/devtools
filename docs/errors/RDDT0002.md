...
- [`packages/rolldown/src/node/diagnostics.ts`](https://github.com/vitejs/devtools/blob/main/packages/rolldown/src/node/diagnostics.ts) — defines `RDDT0002` (level: `warn`).
