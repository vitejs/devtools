...
- [`packages/core/src/node/rpc/internal/docks-on-launch.ts`](https://github.com/vitejs/devtools/blob/main/packages/core/src/node/rpc/internal/docks-on-launch.ts) — the `devtoolskit:internal:docks:on-launch` handler verifies the entry's `type === 'launcher'`; throws `DTK0031` when it isn't.
- [`packages/core/src/node/diagnostics.ts`](https://github.com/vitejs/devtools/blob/main/packages/core/src/node/diagnostics.ts) — defines `DTK0031`.
