...
- [`packages/kit/src/node/create-install-launcher.ts`](https://github.com/vitejs/devtools/blob/main/packages/kit/src/node/create-install-launcher.ts) — the launcher's `onLaunch` throws this when `addDependency(...)` rejects.
