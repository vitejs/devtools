...
- [Standalone CLI recipe](/devframe/standalone-cli) — end-to-end walk-through
- [Client](/devframe/client) — `connectDevtool` reference
- [Adapters](/devframe/adapters) — CLI / Vite / Build / SPA / Kit / Embedded / MCP
