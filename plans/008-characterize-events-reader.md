# Plan 008: Characterization tests for `events-reader` + `log-cache`
...
is a **prerequisite for plan 009** (breaking up the god class).
...
- The parser's line/offset logic makes a faithful on-disk fixture test impractical without
  ...
  report what could not be characterized (this bounds plan 009's risk).
...
- These tests are the safety net for plan 009 (god-class breakup). Keep them at the public
