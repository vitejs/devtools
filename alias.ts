...
export const alias = {
  ...
  'devframe/helpers/nuxt/runtime/plugin.client': r('devframe/src/helpers/nuxt/runtime/plugin.client.ts'),
  'devframe/helpers/nuxt': r('devframe/src/helpers/nuxt/index.ts'),
