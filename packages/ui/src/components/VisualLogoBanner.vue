...
<template>
  <div class="flex gap-2 group" p8 relative>
    ...
    <VisualLogo pointer-events-none h-5em w-5em translate-y--6px />
    <span pointer-events-none text-3em op50 text-stroke-hex-888 text-stroke-1.5px text-transparent font-bold>DEVTOOLS</span>
  </div>
</template>
