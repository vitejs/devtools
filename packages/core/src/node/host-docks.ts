import type { DevToolsDockEntry, DevToolsDockHost as DevToolsDockHostType, DevToolsDocksUserSettings, DevToolsDockUserEntry, DevToolsNodeContext, DevToolsViewBuiltin, DevToolsViewIframe, RemoteConnectionInfo, RemoteDockOptions } from '@vitejs/devtools-kit'
import type { SharedState } from '@vitejs/devtools-kit/utils/shared-state'
import { DEFAULT_STATE_USER_SETTINGS, REMOTE_CONNECTION_KEY } from '@vitejs/devtools-kit/constants'
